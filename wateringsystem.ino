 ...
 * 
 * For E2P32 WROOOM-32
 * See https://www.youtube.com/watch?v=xPlN_Tk3VLQ
 * 
 * 
 * 
...
// ESP const unsigned outputPins[5] = {35, 34, 33, 32, 27};

const byte DNS_PORT = 53;

// Set these to your desired credentials.
const char *ssid = "KevgorNET Watering System";
const char *password = "Pissoff1234!";
...
String responseHTML = ""
  "<!DOCTYPE html><html><head><title>KevgorNET</title></head><body>"
  "<h1>Hello Watering System!</h1><p>This the website for the watering controller.</p></body></html>";
...
const char string_M[]  = "Monday";
const char string_T[]  = "Tuesday";
const char string_W[] = "Wednesday";
const char string_TH[] = "Thursday";
const char string_F[] = "Friday";
